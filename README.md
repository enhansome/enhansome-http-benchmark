...
* [**k6**](https://github.com/loadimpact/k6) ⭐ 31,261 | 🐛 778 | 🌐 Go | 📅 2026-08-14 - A modern load testing tool scriptable in ES6 JS with support for HTTP/1.1, HTTP/2.0 and WebSocket, written in Go (`golang`)
* [**vegeta**](https://github.com/tsenart/vegeta) ⭐ 25,145 | 🐛 121 | 🌐 Go | 📅 2026-02-16 – HTTP load testing tool and library, written in Go (`golang`)
...
* [**oha**](https://github.com/hatoo/oha) ⭐ 10,481 | 🐛 58 | 🌐 Rust | 📅 2026-08-02 – HTTP load generator, inspired by rakyll/hey with tui animation, written in `Rust`
...
* [**wrk2**](https://github.com/giltene/wrk2) ⭐ 4,620 | 🐛 106 | 🌐 C | 📅 2024-03-03 – constant throughput, correct latency recording variant of wrk, written in `C`/`Lua`
...
* [**hoppscotch**](https://github.com/hoppscotch/hoppscotch) ⭐ 80,029 | 🐛 786 | 🌐 TypeScript | 📅 2026-08-05 - API request builder
* [**curl**](https://github.com/curl/curl) ⭐ 42,602 | 🐛 37 | 🌐 C | 📅 2026-08-14 – Powerful features command-line tool for transferring data specified with URL syntax, written in `C`
  * [Online curl command line builde](https://curlbuilder.com/)
* [**httpie**](https://github.com/jkbrzt/httpie) ⭐ 38,419 | 🐛 330 | 🌐 Python | 📅 2024-12-17 – client, user-friendly curl replacement with intuitive UI, JSON support, syntax highlighting, wget-like downloads, extensions, written in `Python`
* [**jq**](https://github.com/stedolan/jq) ⭐ 35,453 | 🐛 472 | 🌐 C | 📅 2026-08-12 – is a lightweight and flexible command-line JSON processor, written in `C`
* [**hurl**](https://github.com/Orange-OpenSource/hurl) ⭐ 19,143 | 🐛 204 | 🌐 Rust | 📅 2026-08-14 - Hurl is a command line tool that runs HTTP requests defined in a simple plain text format
* [**Keploy**](https://github.com/keploy/keploy) ⭐ 18,396 | 🐛 704 | 🌐 Go | 📅 2026-08-13 - Open source ai testing platform that records user traffic as test cases and mocks (infrastructure virtualisation along withDBs) and uses AI to expand the API, schema and code coverage of the backend regression test suite. It also auto-generates tests with assertions and is used for contract testing, functional and performance testing using AI.
* [**curlconverter**](https://github.com/NickCarneiro/curlconverter) ⭐ 8,165 | 🐛 40 | 🌐 TypeScript | 📅 2026-03-10 – convert curl commands to python, javascript, php
* [**xh**](https://github.com/ducaale/xh) ⭐ 8,016 | 🐛 38 | 🌐 Rust | 📅 2026-07-26 – Yet another [HTTPie](https://httpie.org) clone, written in `Rust`
...
* [**jaggr**](https://github.com/rs/jaggr) ⭐ 484 | 🐛 2 | 🌐 Go | 📅 2024-08-29 – JSON Aggregation CLI, Jaggr can be used to integrate [vegeta](https://github.com/tsenart/vegeta) ⭐ 25,145 | 🐛 121 | 🌐 Go | 📅 2026-02-16 with [jplot](https://github.com/rs/jplot) ⭐ 1,178 | 🐛 10 | 🌐 Go | 📅 2025-10-20, written in Go (`golang`)
